...
async def search_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if q == "🔍 Найти макет":
        await update.message.reply_text("Напишите мне, что вы ищете")
        return
    ...
    if q == "❓ FAQ":
        await update.message.reply_text(
            ...
            "❓<b>Нашел ошибку / не нашел макет / нужен совет.</b>\n"
